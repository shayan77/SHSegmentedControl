...
open class SHSegmentedControl: UIControl {
    ...
    public var options: [SHSegmentedControlOption]? {
        get { return nil }
        set {
    ...
    public var alwaysAnnouncesValue: Bool = false
    /// Whether to send the .ValueChanged event immediately or wait for animations to complete. Defaults to `true`.
    public var announcesValueImmediately: Bool = true
    /// Whether the the control should ignore pan gestures. Defaults to `false`.
    public var panningDisabled: Bool = false
    ...
    public var indicatorViewInset: CGFloat = 2.0 {
        didSet {
            updateCornerRadii()
            setNeedsLayout()
        }
    ...
    public var indicatorViewBorderColor: UIColor? {
        get {
    ...
    private lazy var defaultSegments: [SHSegmentedControlSegment] = {
    ...
    public init(frame: CGRect,
                segments: [SHSegmentedControlSegment],
                index: Int = 0,
                options: [SHSegmentedControlOption]? = nil) {
        self.index = index
    ...
    private func completeInit() {
        ...
        tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(SHSegmentedControl.tapped(_:)))
        addGestureRecognizer(tapGestureRecognizer)
        panGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(SHSegmentedControl.panned(_:)))
...
extension SHSegmentedControl: UIGestureRecognizerDelegate {
...
extension SHSegmentedControl {
    public class func appleStyled(frame: CGRect, titles: [String]) -> SHSegmentedControl {
...
public protocol SHSegmentedControlSegment {
